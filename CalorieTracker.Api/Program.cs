...
// 5. Registro del manejador global de excepciones (nativo .NET 9)
builder.Services.AddExceptionHandler<GlobalExceptionHandler>();
builder.Services.AddProblemDetails();

var app = builder.Build();

// Middleware de excepciones globales — debe ir primero en el pipeline
...
nutritionGroup.MapPost("/log", async (HttpContext context, LogFoodRequest request, LogFoodUseCase useCase) =>
{
